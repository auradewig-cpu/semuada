...
interface LanguageToneDefinition {
  ...
  // A named visual/genre reference (English, used inside ai_ready_prompt's
  // "Style:" line -- see buildAiReadyPromptStructureRule) mirroring a technique
  // seen in real-world prompts that get good results from these tools: naming
  // a recognizable genre ("Apple-style commercial", "Gen Z TikTok viral")
  // gives the video model a strong stylistic prior cheaply, instead of relying
  // purely on prose description.
  genreAnchor: string;
}
...
export const LANGUAGE_TONES: Record<LanguageTone, LanguageToneDefinition> = {
  formal_netral: {
    ...
    wpmAdjustment: 0,
    genreAnchor: "clean, trustworthy product commercial",
  },
  santai_ngobrol: {
    id: "santai_ngobrol",
    ...
    wpmAdjustment: 10,
    genreAnchor: "casual influencer selfie-style content",
  },
  gaul_kekinian: {
    id: "gaul_kekinian",
    label: "Gaul/Kekinian",
    ...
    maxWordsPerSentence: 20,
    wpmAdjustment: 12,
    genreAnchor: "Gen Z TikTok viral trend style, authentic creator review",
  },
  elegan_premium: {
    id: "elegan_premium",
    ...
    wpmAdjustment: -5,
    genreAnchor: "Apple-style premium product commercial, luxury advertisement",
  },
  heboh_lebay: {
    id: "heboh_lebay",
    label: "Heboh/Lebay",
    ...
    wpmAdjustment: 15,
    genreAnchor: "hyped reaction-style social video, energetic amateur creator",
  },
  kocak_receh: {
    id: "kocak_receh",
    label: "Kocak/Receh",
    ...
    wpmAdjustment: 8,
    genreAnchor: "funny relatable creator content, lighthearted social video",
  },
  sotoy_santai: {
    id: "sotoy_santai",
    label: "Sotoy Santai",
    ...
    wpmAdjustment: 5,
    genreAnchor: "friendly explainer-style creator content",
  },
  curhat_personal: {
    id: "curhat_personal",
    ...
    maxWordsPerSentence: 18,
    wpmAdjustment: -10,
    genreAnchor: "intimate personal vlog style, soft cinematic",
  },
  sarkas_julid: {
    id: "sarkas_julid",
    ...
    maxWordsPerSentence: 16,
    wpmAdjustment: 5,
    genreAnchor: "witty deadpan creator commentary style",
  },
  ibu_bapack_relatable: {
    ...
    maxWordsPerSentence: 16,
    wpmAdjustment: 3,
    genreAnchor: "warm family lifestyle video, relatable parent content",
  },
};
